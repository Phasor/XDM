...
echo "  2. Edit DM personality:    nano $APP_DIR/prompts/personality.txt"
echo "  3. (Optional) Tweeting:    nano $APP_DIR/prompts/character.txt"
echo "     then set tweeting.enabled=true and fal_ai.api_key in config.json"
echo "  4. Start the bot:          sudo systemctl start xdm"
echo "  5. Check status:           sudo systemctl status xdm"
echo "  6. View logs:              sudo journalctl -u xdm -f"
echo ""
